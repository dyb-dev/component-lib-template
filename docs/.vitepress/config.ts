 ...
 * @LastEditors: dyb-dev
 * @LastEditTime: 2024-09-12 21:43:50
...
const configFn: UserConfigFn<DefaultTheme.Config> = ({ mode }) => {
    ...
    return defineConfig({
        ...
        themeConfig: {
            ...
            logo: _logoPath,
            // 左上角 标题
            siteTitle: "Component-Lib-Template",
            // 右上角 icon
            ...
            footer: {
                // 页脚文本
                message:
                    'Released under the <a href="https://github.com/dyb-dev/component-lib-template/blob/main/LICENSE" target="_blank">MIT License</a>.',
                // 版权信息
                copyright: 'Copyright © 2019-present <a href="https://github.com/dyb-dev" target="_blank">dyb-dev</a>'
            },
            // 页面编辑链接配置
            editLink: {
                pattern: "https://github.com/dyb-dev/component-lib-template/tree/main/docs/src/views/:path",
                text: "为此页面提供修改建议"
            },
