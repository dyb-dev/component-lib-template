 ...
 * @LastEditors: dyb-dev
 * @LastEditTime: 2024-10-22 14:15:40
 * @FilePath: /component-lib-template/src/components/CalendarPro/index.vue
...
<template>
    <Popup
        v-if="props.poppable"
        class="component-lib-template-calendar-pro"
        style="height: 80%"
        v-model:show="_show"
        position="bottom"
        :round="true"
...
<style lang="scss">
.component-lib-template-calendar-pro {
    & .van-calendar__body {
