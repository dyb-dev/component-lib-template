...
const highlightProps = computed<THighlightProps>(() => {
    ...
    return {
        ...
        highlightClass: "component-lib-template-list-pro__top-desc__highlight"
    }
...
/** STATIC: 根元素类名 */
const rootClassName = "component-lib-template-list-pro"
...
<template>
    ...
    >
        <slot v-if="props.enableTopDesc" name="top-desc" :total-size="totalSize">
            <Highlight class="component-lib-template-list-pro__top-desc" v-bind="highlightProps" />
        </slot>
...
<style lang="scss">
.component-lib-template-list-pro {
    width: 100%;
    height: 100%;
